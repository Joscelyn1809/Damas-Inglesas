...
public class Canvas {
    ...
    public static Canvas getCanvas() {
        if (canvasSingleton == null) {
            canvasSingleton = new Canvas("Damas", 600, 600,
                    Color.white);
        }
    ...
    public void setForegroundColor(String colorString) {
        ...
        switch (colorString) {
            ...
            case "beige" ->
                graphic.setColor(new Color(226, 186, 177));
            case "cafe claro" ->
                graphic.setColor(new Color(197, 163, 155));
            case "cafe" ->
                graphic.setColor(new Color(160, 119, 111));
            case "gris" ->
                graphic.setColor(new Color(115, 100, 100));
            case "brown" ->
                graphic.setColor(new Color(136, 129, 103));
            case "orange" ->
                graphic.setColor(new Color(235, 135, 0));
            default ->
                graphic.setColor(Color.black);
        }
    }
